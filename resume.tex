...
\resumeSubheading
{Machine Learning Intern}{Jun. 2023 -- Present}
{MOLOCO, Inc.}{Redwood City, CA}
\resumeItemListStart
\resumeItem{Developed a TensorFlow model, using data augmentation, to predict user engagement with ads, improving AUC from \textbf{0.77} to \textbf{0.85}}
