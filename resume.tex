...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
        ...
        \textbf{Frameworks}{: React, Vue, Node.js, Express.js, Tailwind CSS, Unity, Arduino, Bootstrap, Svelte} \\
        \textbf{Developer Tools}{: Git, Docker, Kubernetes, Google Cloud Platform, AWS, Azure} \\
        \textbf{Libraries}{: PyTorch, fast.ai, TensorFlow, Keras, NumPy, OpenCV, pandas, Matplotlib, FastAPI, Flask} \\
        }}
\end{itemize}
